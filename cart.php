...
if (isset($_SESSION['user']) && isset($_SESSION['user']['id'])) {
    // Logged-in user - fetch from cart table
    ...
    // Guest user - fetch from cart_session table
    ...
    $cartQuery = "
        ...
        LEFT JOIN color col ON col.id = cs.color_id
...
<body>
                                ...
                                ?>
                                    <div class="cart-item" data-index="<?= $index ?>" data-price="<?= $item['price'] ?>">
                                        <div class="item-image">
                                            <img src="<?= htmlspecialchars($item['img_url'] ?? 'imgs/no-image.png') ?>"
                                        ...
                                        <div class="item-details">
                                            <div>
                                                ...
                                                <div class="item-meta">
                                                    ...
                                                    <?php endif; ?>
                                                    <span class="ms-2 text-muted">Stock: <?= $item['stock'] ?></span>
                                                </div>
                                            </div>
    ...
    <script>
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.getElementById(`price-${index}`).textContent =
                            'LKR ' + newItemTotal.toLocaleString('en-US', {
        ...
        function updateTotals() {
            ...
            document.querySelector('.summary-row:nth-of-type(2) .summary-value').textContent =
                shipping === 0 ? 'FREE' : 'LKR ' + shipping.toLocaleString('en-US', {
                    maximumFractionDigits: 0
                });

            document.getElementById('tax').textContent =
                'LKR ' + tax.toLocaleString('en-US', {
                    maximumFractionDigits: 0
                });
